...
public class Menu1 extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
     ...
     //if(SG.getSESSION_ROLE()==0){
        ...
        addMenu(new ModelMenu(GoogleMaterialDesignIcon.SEARCH, "Reportes", "Regiones con mas envios", "Total de paquetes enviados", "Ingreso totales", "Usuarios com mas paquetes"));
