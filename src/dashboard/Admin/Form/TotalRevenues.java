...
public class TotalRevenues extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new Object[]{new ModelProfile(new ImageIcon(getClass().getResource("/icon/profile.jpg")), "Bruce Castillo"), "Zapatos","Guatemala", "Mixco", "Contra entrega","27/02/2023", "Q400"});
    ...
    private void initComponents() {
        ...
        txtUserName.setText("Total de ingresos: Q400");
        ...
        textField1.setLabelText("Buscar por producto");
