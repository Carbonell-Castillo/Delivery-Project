...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new Dashboard.style.menu.Button();
        cmdDelete = new Dashboard.style.menu.Button();
    ...
    private Dashboard.style.menu.Button cmdDelete;
    private Dashboard.style.menu.Button cmdEdit;
